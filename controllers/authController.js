...
export const registerController=async(req,res)=>{
    try {
        ...
        //  we check exisiting user we can not make multiple user with same ids
        ...
        // now after all validation we register user
...
export const forgotPasswordController=async(req,res)=>{
    try{
        ...
        res.status(200).send({
            success:true,
            massage:"Password Reaset Successfully",
        })
    }
    catch(error){
        console.log(error);
