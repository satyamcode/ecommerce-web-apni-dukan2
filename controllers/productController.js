...
export const updateProductController= async(req,res)=>{
    try{
        ...
        res.status(500).send({
            success: false,
            error,
            message:"error in productupdateController"
        })
    };
...
// *****product count controller(pagination)
...
try{
    ...
    res.status(200).send({
        ...
        res.status(400).send({
            success:false,
            message:'error i per page controller',
            error,
        });
